...
public class SeccionCotsRowMapper implements RowMapper<List<SeccionElectoral>> {
	...
	public List<SeccionElectoral> mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		do {
			...
			seccion.setDistritoId(rs.getLong("distrito_id"));
			seccion.setNombreDistrito(rs.getString("federal"));
