...
public class RepresentantesRepository implements IRepresentanteRepository {
	...
	public void save(Representantes representantes) {
		...
		template.update(sql, new Object[] { representantes.getApellidoMaterno(), representantes.getApellidoPaterno(),
				representantes.getCalle(), representantes.getClaveElector(), representantes.getColonia(), representantes.getCorreo(),
				representantes.getCp(), representantes.getFechaRegistro(), representantes.getIneLado1(), representantes.getIneLado2(),
				representantes.getInePdf(), representantes.getNombre(), representantes.getNumExterior(), representantes.getNumInterior(),
				representantes.getPropuesto(), representantes.getRuta(), representantes.getTelCasa(), representantes.getTelCelular(),
				representantes.getTipo(), representantes.getDistritoFederal(), representantes.getEstado(), representantes.getMunicipio(),
				representantes.getSeccionElectoral(), representantes.getUsuario()});
	}
